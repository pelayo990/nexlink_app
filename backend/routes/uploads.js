...
router.post('/imagen', authMiddleware, upload.single('imagen'), asyncHandler(async (req, res) => {
...
router.delete('/imagen/:public_id', authMiddleware, asyncHandler(async (req, res) => {
  try {
